      ...
      items: [
        {
          ...
          fullDescription: "Bizzat yaşadığım bir problemi çözmek için başlattığım kişisel proje. Vera Finans; yapay zeka görüntü işlemeyle fiş dijitalleştirme, envanter yönetimi ve gelir-gider takibi sunan bir finans asistanı. Başlangıçta sadece kendi ihtiyacım için geliştirdiğim bir araç, zamanla başkalarının da kullandığı aktif bir ürüne dönüştü.",
